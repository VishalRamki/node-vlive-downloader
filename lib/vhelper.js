...
class VHelper {
   ...
   * 
   * @param {*} encode 
   * @returns Promise<{VideoObjectSchema}>
   */
  ...
  /**
   * 
   * @param {{VideoObjectSchema}} cb - This is the Video Schema which contains all the data needed to download as well as describe the video stream/file.
   * @param {func} progress - a function that receives the download progress
   * @returns Promise<{
   *  Path: string
   * }>
   */
